...
# ===== 录制区域参数（由区域选择工具生成） =====
TARGET_URL = "https://www.sge.com.cn/sjzx/yshqbg"
SELECTION = {
    "tagName": "div",
    "id": "",
    "className": "jzjcont pl30 pt30 pr30 pb30",
    "text": "合约\n                最新价\n                最高价\n                最低价\n                今开盘\n              \n  ",
    "href": "",
    "cssSelector": "div.jzk_main:nth-of-type(6) > div.jzk_newsCenter_Main > div.jzk_newsCenter_Cont:nth-of-type(2) > div.jzk_newsCenter_ContRight:nth-of-type(2) > div.jzk_newsCenter_meeting:nth-of-type(2) > div.jzjcont.pl30.pt30.pr30.pb30:nth-of-type(2)",
    "xpath": "/html/body[1]/div[6]/div[1]/div[2]/div[2]/div[2]/div[2]",
    "x": 341,
    "y": 451,
    "width": 860,
    "height": 797
...
CENTER_X = 771
CENTER_Y = 850
CSS_SELECTOR = 'div.jzk_main:nth-of-type(6) > div.jzk_newsCenter_Main > div.jzk_newsCenter_Cont:nth-of-type(2) > div.jzk_newsCenter_ContRight:nth-of-type(2) > div.jzk_newsCenter_meeting:nth-of-type(2) > div.jzjcont.pl30.pt30.pr30.pb30:nth-of-type(2)'
XPATH = '/html/body[1]/div[6]/div[1]/div[2]/div[2]/div[2]/div[2]'
