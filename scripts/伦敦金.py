...
# ===== 录制区域参数（由区域选择工具生成） =====
TARGET_URL = "https://finance.sina.com.cn/futures/quotes/XAU.shtml"
SELECTION = {
    "tagName": "td",
    "id": "",
    "className": "",
    "text": "4087.01\n\t\t\t\t\t\t\t+15.86 +0.39%\n\t\t\t\t\t\t\n\t\t\t\t\t\t2026-06-11 18:21:00",
    "href": "",
    "cssSelector": "#table-box-futures-hq > tbody > tr:nth-of-type(1) > td:nth-of-type(1)",
    "xpath": "/html/body[1]/div[3]/div[2]/div[2]/div[3]/table[1]/tbody[1]/tr[1]/td[1]",
    "x": 348,
    "y": 415,
    "width": 223,
    "height": 74
...
CENTER_X = 460
CENTER_Y = 452
CSS_SELECTOR = '#table-box-futures-hq > tbody > tr:nth-of-type(1) > td:nth-of-type(1)'
XPATH = '/html/body[1]/div[3]/div[2]/div[2]/div[3]/table[1]/tbody[1]/tr[1]/td[1]'
